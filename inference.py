...
if __name__ == "__main__":
  ...
  config = dict()
  with open("logs/lego_example/args.txt") as f:
      for line in f:
        k, v = line.split("=")
        config[k.strip()] = simplest_type(v.strip())
  config.update({"netchunk": 65536})
  ...
  # Create nerf model
  _, render_kwargs_test, start, grad_vars, models = create_nerf(
      args)
